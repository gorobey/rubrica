            ...
            <div class="box-body">
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <?php endif ?>
                        <form id="form_perfiles" action="" method="POST">
                            <div class="form-group">
                                <label for="texto">Nombre del Perfil:</label>
                                <input type="text" class="form-control" id="texto" name="texto" value="" autofocus>
                            ...
                            <div class="form-group">
                                ...
                                <?php $link = "admin2.php?id_usuario=" . $id_usuario 
                                                ...
                                                . "&enlace=vistas/administracion/perfiles/list.php" 
