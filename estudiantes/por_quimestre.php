...
<script type="text/javascript">
	...
	function cargarPeriodosEvaluacion()
	{
		...
		if (id_periodo_lectivo == 0) {
			...
			$.post("cargar_periodos_evaluacion_principales.php", { id_periodo_lectivo: id_periodo_lectivo },
				function(resultado)
				{
					if(resultado == false)
					{
	...
	function consultarEstudiante()
	{
		...
		if (id_periodo_lectivo==0) {
			...
			$.post("obtener_periodos_estudiante.php", 
...
<div id="pagina">
	<div id="titulo_pagina">
    	Consultar Calificaciones por Quimestre
    </div>
