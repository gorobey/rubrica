    ...
    <div class="modal fade" id="editUser" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-default" data-dismiss="modal"><span class="glyphicon glyphicon-remove"></span> Cancelar</button>
                    <button type="button" class="btn btn-primary" onclick="editUsuario()"><span class="glyphicon glyphicon-floppy-disk"></span> Editar</a>
                </div>
            </div>
        </div>
    </div>
    <!-- Modal Asociar Usuario -->
    <div class="modal fade" id="assoc_user" tabindex="-1" role="dialog" aria-labelledby="lblAssociate" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    ...
                    <center><h4 class="modal-title" id="lblAssociate">Asociar Usuario</h4></center>
                </div>
                <div class="modal-body">
                    <div class="row">
                        <div class="col-sm-12">
                            <form id="frm_assoc_user" action="" method="post">
                                <div class="form-group has-feedback">
                                    <label for="user_associated">Usuario:</label>
                                    <input type="text" class="form-control" id="user_associated" value="">
                                    <span class="help-desk error" id="mensaje1"></span>
                                </div>
                            </form>
                        </div>
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-default" data-dismiss="modal"><span class="glyphicon glyphicon-remove"></span> Cancelar</button>
                    <button type="button" class="btn btn-primary" onclick="asociarUsuario()"><span class="glyphicon glyphicon-floppy-disk"></span> Asociar</a>
                </div>
            </div>
        </div>
    </div>
        ...
        function editarUsuario(id_usuario)
        {
            ...
            $.ajax({
                ...
                success: function(resultado){
                    ...
                    $("#id_usuario").val(JSONUsuario.id_usuario);
                    $("#edit_us_titulo").val(JSONUsuario.us_titulo);
                    $("#edit_us_apellidos").val(JSONUsuario.us_apellidos);
                    $("#edit_us_nombres").val(JSONUsuario.us_nombres);
                    $("#edit_us_login").val(JSONUsuario.us_login);
                    $("#edit_us_password").val(JSONUsuario.us_password);
                    $('#editUser').modal('show');
                }
            });
        }
