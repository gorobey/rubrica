...
<script type="text/javascript">
				...
				else
				{
					...
					$.post("tutores/obtener_nombre_paralelo.php",
						...
						function(resultado)
						{
							...
							{
								$("#titulo_pagina").html("DE GRACIA DE " + resultado);
							}
						}
					);
	...
	function cargarEstudiantesParalelo(id_paralelo, id_asignatura)
	{
		...
		$.post("tutores/listar_de_gracia.php", 
			{ 
...
<div id="pagina">
	...
	<div id="pag_nomina_estudiantes">
      ...
      <form id="formulario_reporte" action="reportes/reporte_de_gracia.php" method="post" target="_blank">
