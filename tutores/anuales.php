...
<script type="text/javascript">
	...
	function cargarEstudiantesParalelo(id_paralelo, id_asignatura)
	{
		...
		$.post("tutores/listar_calificaciones_periodo_lectivo.php", 
			{ 
...
<div id="pagina">
	...
	<div id="barra_principal">
      <table id="tabla_navegacion" border="0" cellpadding="0" cellspacing="0">
         <tr>
            ...
            <td width="*" class="fuente9"> &nbsp;Impresi&oacute;n para juntas <input type="checkbox" id="imprimir_para_juntas" /> </td>
         </tr>
      </table>
	...
	<div id="pag_nomina_estudiantes">
      ...
      <form id="formulario_reporte" action="php_excel/reporte_anual_excel.php" method="post" target="_self">
