<?php
	...
	if ($criterios_evaluacion->existeCriterioEvaluacion($criterios_evaluacion->id_rubrica_evaluacion, $criterios_evaluacion->cr_descripcion))
		echo "Ya existe el criterio de evaluaci&oacute;n en la base de datos...";
	else
		echo $criterios_evaluacion->insertarCriterioEvaluacion();
?>
