...
<script type="text/javascript">
	...
	function listarDocentes(iDesplegar)
	{
		$.get("usuario/listar_usuarios.php", { id_perfil: 2 },
			function(resultado)
			{
				if(resultado == false)
				{
	...
	function actualizarUsuario()
	{
    	...
    	if(!reg_titulo.test(us_titulo)) {
			...
			$.ajax({
					...
					data: "id_usuario="+id_usuario+"&id_perfil=2&us_titulo="+us_titulo+"&us_apellidos="+us_apellidos+"&us_nombres="+us_nombres+"&us_fullname="+us_fullname+"&us_login="+us_login+"&us_password="+us_password,
...
<div id="pagina">
   ...
   <div id="pag_usuarios">
      ...
      <div class="header2"> LISTA DE DOCENTES EXISTENTES </div>
